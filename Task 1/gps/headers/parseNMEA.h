...
namespace NMEA
{
  ...
  /* Split a NMEA Sentence by a delimiter
   * Takes a sentence, the delimiter, and whether it should return the value
   * before or after the delimiter
   * Returns a substring of the original sentence after splitting by delimiter
   */
  std::string splitSentence(std::string, std::string, bool);
